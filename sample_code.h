...
struct exec_item	f1= { .base_address=0x000a2380, .length=sizeof(function1), .text=function1 };
struct exec_item	f2= { .base_address=0x00099F00, .length=sizeof(function2), .text=function2 };
struct exec_item	f3= { .base_address=0x00099F00, .length=sizeof(function3), .text=function3 };
